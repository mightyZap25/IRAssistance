...
const ROLE_MENU_MAP = {
    admin: ['/', '/settings', '/parts', '/bom', '/customers', '/prod-requests', '/prod-execution', '/purchasing', '/outsourcing', '/inventory', '/receiving/inspection', '/qa/config', '/qa/process', '/qa/dashboard', '/qa/dev-testing', '/transactions', '/manufacturers', '/vendors', '/ecn', '/hr/attendance', '/project/dashboard', '/project/issues', '/project/management', '/project/tasks', '/project/task-calendar', '/sales/dashboard', '/sales/quotations', '/sales/billing', '/workspace/calendar', '/workspace/meetings', '/workspace/files', '/workspace/mail', '/workspace/memo', '/workspace/chat'],
    ...
    qa: ['/', '/receiving/inspection', '/qa/config', '/qa/process', '/qa/dashboard', '/qa/dev-testing', '/inventory', '/transactions', '/hr/attendance', '/project/management', '/project/tasks', '/project/task-calendar', '/workspace/calendar', '/workspace/meetings', '/workspace/files', '/workspace/mail', '/workspace/memo', '/workspace/chat'],
    ...
    manager: ['/', '/customers', '/prod-requests', '/purchasing', '/outsourcing', '/inventory', '/qa/config', '/qa/process', '/qa/dashboard', '/qa/dev-testing', '/transactions', '/manufacturers', '/vendors', '/hr/attendance', '/project/dashboard', '/project/issues', '/project/management', '/project/tasks', '/project/task-calendar', '/sales/dashboard', '/sales/quotations', '/sales/billing', '/workspace/calendar', '/workspace/meetings', '/workspace/files', '/workspace/mail', '/workspace/memo', '/workspace/chat'],
...
export default function Sidebar() {
    ...
    const ALL_MENU_GROUPS = [
        ...
        { title: '재고 및 품질', items: [ { name: '품질 대시보드', path: '/qa/dashboard', icon: TrendingUp }, { name: '재고 현황', path: '/inventory', icon: Package }, { name: '수입 검사', path: '/receiving/inspection', icon: FileCheck }, { name: '품질 공정 관리', path: '/qa/process', icon: Activity }, { name: '품질 기준 설정', path: '/qa/config', icon: Settings }, { name: '개발 성능 테스트', path: '/qa/dev-testing', icon: Microscope }, { name: '입출고 내역', path: '/transactions', icon: History } ] },
