...
export default function PartsPage() {
    ...
    const [allBoms, setAllBoms] = useState([]); // Cache for impact analysis
    ...
    // Filtered Parts for Detail Panel Sync
    ...
    const [formModalMode, setFormModalMode] = useState('create'); // 'create' or 'edit'
