            ...
            <div className="max-w-[1600px] mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-5">
                    ...
                    <button
                        ...
                        className="group bg-white hover:bg-blue-50 border border-slate-200 hover:border-blue-200 rounded-2xl p-5 text-left shadow-sm hover:shadow-md transition-all duration-200"
                    >
                        <div className="flex items-start justify-between mb-4">
                            <div className="p-2.5 bg-blue-50 group-hover:bg-blue-100 rounded-xl transition-colors">
                                <Coffee className="text-blue-600" size={22}/>
                            </div>
                            <span className="text-[10px] font-black text-blue-600 bg-blue-50 px-2.5 py-1 rounded-full border border-blue-100">클릭하여 신청 →</span>
                        </div>
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">휴가 신청</p>
                                <p className="text-2xl font-black text-slate-900">휴가신청</p>
                                <p className="text-[11px] text-slate-400 mt-1.5">총 {balance.total}일 중 {balance.used}일 사용</p>
                            </div>
                            {/* 잔여일수 / 잔여시간 - 오른쪽에 정렬 */}
                            <div className="text-right">
                                <p className="text-[9px] font-black text-slate-400 uppercase tracking-wider mb-1">잔여 휴가</p>
                                <div className="flex items-end justify-end gap-0">
                                    <div className="flex items-end gap-0.5 pr-2">
                                        <span className="text-xl font-black text-blue-600">{balance.remaining}</span>
                                        <span className="text-[10px] font-bold text-blue-400 mb-0.5">일</span>
                                    </div>
                                    <span className="text-slate-300 font-black text-sm mb-0.5 select-none">/</span>
                                    <div className="flex items-end gap-0.5 pl-2">
                                        <span className="text-xl font-black text-violet-600">{balance.remainingHours}</span>
                                        <span className="text-[10px] font-bold text-violet-400 mb-0.5">시간</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <button
                        ...
                        className="group bg-white hover:bg-emerald-50 border border-slate-200 hover:border-emerald-200 rounded-2xl p-5 text-left shadow-sm hover:shadow-md transition-all duration-200"
                    >
                        <div className="flex items-start justify-between mb-4">
                            <div className="p-2.5 bg-emerald-50 group-hover:bg-emerald-100 rounded-xl transition-colors">
                                <Briefcase className="text-emerald-600" size={22}/>
                            </div>
                            <span className="text-[10px] font-black text-emerald-600 bg-emerald-50 px-2.5 py-1 rounded-full border border-emerald-100">클릭하여 신청 →</span>
                        </div>
                        <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">근태 신청</p>
                        <p className="text-2xl font-black text-slate-900">근태관리</p>
                        <p className="text-[11px] text-slate-400 mt-1.5">유연근로 · 출장 · 외근 신청</p>
                    </button>
                    ...
                    <button
                        ...
                        className={clsx(
                            "group border rounded-2xl p-5 text-left shadow-sm hover:shadow-md transition-all duration-200",
                    ...
                    >
                        <div className="flex items-start justify-between mb-4">
                            <div className={clsx("p-2.5 rounded-xl transition-colors", myPendingApprovals.length > 0 ? "bg-rose-100 group-hover:bg-rose-200" : "bg-slate-100 group-hover:bg-slate-200")}>
                                <ShieldCheck className={myPendingApprovals.length > 0 ? "text-rose-600" : "text-slate-500"} size={22}/>
                            </div>
                            {myPendingApprovals.length > 0 && (
                                <span className="text-[10px] font-black text-white bg-rose-500 px-2.5 py-1 rounded-full animate-pulse">{myPendingApprovals.length}건 처리 필요</span>
                            )}
                        </div>
                        <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">결재 대기</p>
                        <p className={clsx("text-2xl font-black", myPendingApprovals.length > 0 ? "text-rose-700" : "text-slate-900")}>
                            {myPendingApprovals.length > 0 ? `${myPendingApprovals.length}건 대기` : '대기 없음'}
                        </p>
                        <p className="text-[11px] text-slate-400 mt-1.5">내 신청 내역 및 결재할 내역 확인</p>
                    </button>
                </div>
                    ...
                    <div className="w-[280px] min-w-[280px] flex flex-col gap-4">
                        ...
                        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                            <div className="flex items-center justify-between px-4 py-3 border-b border-slate-100">
                                <div className="flex items-center gap-2">
                                    ...
                                    <h2 className="text-xs font-black text-slate-700 uppercase tracking-wider">오늘 근무</h2>
                                </div>
                            ...
                            <div className="p-3">
                                {/* 타이머 */}
                                <div className="text-center py-4 bg-slate-50 rounded-xl border border-slate-100 mb-3">
                                    <p className="text-[9px] font-bold text-slate-400 mb-1 uppercase tracking-wider">Working Time</p>
                                    <p className={clsx(
                                    ...
                                    {attendanceLog?.checkIn && !attendanceLog?.checkOut && (
                                        <span className="inline-flex items-center gap-1 mt-1 text-[9px] font-bold text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded-full border border-emerald-100">
                                ...
                                <div className="space-y-2">
                                    {!attendanceLog?.checkIn ? (
                                        <button
                                            ...
                                            className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-xl font-black flex justify-center items-center gap-2 text-sm shadow-sm shadow-blue-200 transition-all active:scale-95"
                                        >
                                            <LogIn size={16}/> 출근하기
                                        </button>
                                    ) : (
                                        <div className="w-full bg-emerald-50 border border-emerald-200 py-3 rounded-xl font-black flex justify-center items-center gap-2 text-emerald-600 text-sm">
                                            <CheckCircle2 size={16}/> {attendanceLog.autoCheckIn ? '자동출근' : '출근완료'}
                                        </div>
                                    )}
                                    <button
                                        id="btn-check-out"
                                        ...
                                        className="w-full bg-slate-100 hover:bg-slate-200 disabled:opacity-40 disabled:cursor-not-allowed text-slate-600 py-3 rounded-xl font-black flex justify-center items-center gap-2 border border-slate-200 text-sm transition-all"
                                    >
                                        <LogOut size={16}/> 퇴근하기
                                    </button>
                                </div>
                        ...
                        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                            <div className="flex items-center gap-2 px-4 py-3 border-b border-slate-100">
                                ...
                                <h2 className="text-xs font-black text-slate-700 uppercase tracking-wider">근태 현황</h2>
                            </div>
                            <div className="p-3 space-y-2">
                                ...
                                <div className="flex items-center justify-between p-3 bg-blue-50 rounded-xl border border-blue-100">
                                    <div className="flex items-center gap-2.5">
                                        ...
                                        <div>
                                            <p className="text-[10px] font-black text-blue-500 uppercase tracking-wider">잔여 근로시간</p>
                                            <p className="text-lg font-black text-blue-700">{workStats.remaining}<span className="text-xs font-bold ml-0.5">h</span></p>
                                        </div>
                                    </div>
                                    <div className="text-right">
                                        <p className="text-[9px] text-blue-400">주 {workStats.limit}h 기준</p>
                                        <div className="mt-1 w-16 bg-blue-200 rounded-full h-1.5 overflow-hidden">
                                            <div className="h-full bg-blue-500 rounded-full" style={{ width: `${(workStats.remaining / workStats.limit) * 100}%` }}/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center justify-between p-3 bg-emerald-50 rounded-xl border border-emerald-100">
                                    <div className="flex items-center gap-2.5">
                                        ...
                                        <div>
                                            <p className="text-[10px] font-black text-emerald-600 uppercase tracking-wider">누적 근로시간</p>
                                            <p className="text-lg font-black text-emerald-700">{workStats.accumulated}<span className="text-xs font-bold ml-0.5">h</span></p>
                                        </div>
                                    </div>
                                    <p className="text-[9px] text-emerald-400">이번 달 누계</p>
                                </div>
                                ...
                                <div className="flex items-center justify-between p-3 bg-amber-50 rounded-xl border border-amber-100">
                                    <div className="flex items-center gap-2.5">
                                        ...
                                        <div>
                                            <p className="text-[10px] font-black text-amber-600 uppercase tracking-wider">이번주 근로시간</p>
                                            <p className="text-lg font-black text-amber-700">{workStats.weekly}<span className="text-xs font-bold ml-0.5">h</span></p>
                                        </div>
                                    </div>
                                    <div className="text-right">
                                        <p className="text-[9px] text-amber-400">/ {workStats.limit}h</p>
                                        <div className="mt-1 w-16 bg-amber-200 rounded-full h-1.5 overflow-hidden">
                        ...
                        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                            <div className="flex items-center gap-2 px-4 py-3 border-b border-slate-100">
                                ...
                                <h2 className="text-xs font-black text-slate-700 uppercase tracking-wider">근무 신청</h2>
                            </div>
                            <div className="p-2 space-y-1.5">
                                ...
                                <button
                                    ...
                                    className="w-full flex items-center gap-3 px-3 py-3 rounded-xl hover:bg-slate-50 border border-transparent hover:border-slate-200 transition-all group text-left"
                                >
                                    <div className="w-8 h-8 rounded-lg bg-indigo-50 group-hover:bg-indigo-100 flex items-center justify-center transition-colors flex-shrink-0">
                                        <Clock size={16} className="text-indigo-600"/>
                                    </div>
                                    <div className="flex-1 min-w-0">
                                        <p className="text-sm font-bold text-slate-700 group-hover:text-indigo-700 transition-colors">근무시간 조정 신청</p>
                                        <p className="text-[10px] text-slate-400 mt-0.5">익월 기본 출퇴근 시간 변경</p>
                                    </div>
                        ...
                        {workStats.overtime > 0 && (
                            <div className="bg-rose-50 border border-rose-200 rounded-2xl p-3 flex items-center gap-2.5">
                                ...
                                <div>
                                    <p className="text-xs font-black text-rose-600">연장 근로 {workStats.overtime}h 발생</p>
                                    <p className="text-[10px] text-rose-400 mt-0.5">법정 52시간 준수 필요</p>
                                </div>
                            </div>
                        )}
                    </div>
